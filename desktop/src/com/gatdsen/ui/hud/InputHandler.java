...
public class InputHandler implements InputProcessor, com.gatdsen.manager.InputProcessor {
     ...
     */
    public static void playerBuyedEnemy(int playerId, Enemy.Type enemyType) {
     ...
     */
    public void playerFieldLeftClicked(int playerId, int x, int y, Tower.TowerType towerType, Tower.TargetOption targetOption) {
